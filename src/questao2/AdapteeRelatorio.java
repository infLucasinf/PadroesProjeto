/* O pacote questao2 significa, a resposta da segundaa questão.Na segunda questão, nós utilizamos o padrão adpater, 
 * como forma de evitar a explosão de classes.
 * Nós temos o método gerandoRelatorio que recebe como parametro uma obra, um tipo de relatório, 
 * um tipo de formato de relatório e retorna o formato em string.
 */
